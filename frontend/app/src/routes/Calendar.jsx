...
const Calendar = () => {
    ...
    const eventClick = (info) => {
        ...
        const startDate = `${startDatetime.getFullYear().toString()}-${zeroPad(startDatetime.getMonth() + 1)}-${zeroPad(startDatetime.getDate())}`;

        const endDate = `${endDatetime.getFullYear().toString()}-${zeroPad(endDatetime.getMonth() + 1)}-${zeroPad(endDatetime.getDate())}`;
