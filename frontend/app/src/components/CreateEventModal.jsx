        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    ...
                    <Input placeholder="タイトル" value={title} onChange={(event) => setTitle(event.target.value)} mb="16px" />
                    <Text fontWeight="bold">ディスクリプション</Text>
                    <Input placeholder="ディスクリプション" value={description} onChange={(event) => setDescription(event.target.value)} mb="16px" />
